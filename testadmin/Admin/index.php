        ...
        switch ($_GET["act"]) {
            ...
            case "createUserForm":
                if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST["username"])) {
                    ...
                    $person_type_id = $_POST['person_type_id'];
                    createUser($username, $email, $password, $role_id, $person_type_id);
                    $users = getAllUsers();
                    include "view/users/users.php";
                } else {
                    $roles = getAllRoles();
                    $person_types = getall_dm();
                    include "view/users/createUserForm.php";
                }
                break;
            case "updateUserForm":
                if (isset($_GET["id"])) {
                    ...
                    $roles = getAllRoles();
                    $person_types = getall_dm();
                    include "view/users/updateUserForm.php";
                }
                if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST["id"])) {
                    $id = $_POST['id'];
                    $username = $_POST['username'];
                    ...
                    $role_id = $_POST['role_id'];
                    $person_type_id = $_POST['person_type_id'];
                    updateUser($id, $username, $email, $role_id, $person_type_id);
                    $users = getAllUsers();
                    include "view/users/users.php";
                }
                break;
                    ...
                    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirm_delete'])) {
                        ...
                        echo '
                                <div class="confirmation-form">
                                    ...
                                    <a href="index.php?act=users">No</a>
                                </div>
                            ';
                    }
                }
