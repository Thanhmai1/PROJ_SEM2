...
<head>
    ...
    <!-- <style>
        css giống trên có thể dùng 1 trong 2 nếu hỏng
    ...
    <div class="container">
        ...
        <script>
            function calculateBMI() {
                ...
                if (height > 0 && weight > 0) {
                    ...
                    fetch('get_dishes_by_bmi.php', {
                        ...
                        body: 'bmi=' + encodeURIComponent(bmiRounded)
                    })
                        ...
                        .catch((error) => {
                            ...
                            document.getElementById('result').innerText = 'Error fetching dishes.';
                        });
            ...
            <div class='recipe-card'>
                ...
                <h3>${dish.title}</h3>
                <p><strong>Category:</strong> ${dish.namecategories}</p>
        ...
        <div class="recipes-container">
            ...
            // Check if 'bmi' is set in the POST request
            if (isset($_POST['bmi'])) {
                $bmi = $_POST['bmi'];
            ...
            WHERE pt.bmi_value <= ?"; // Adjust this line based on your BMI logic
            
                // Prepare and bind the statement
                $stmt = $conn->prepare($sql);
                $stmt->bind_param("d", $bmi); // 'd' stands for double
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        $dishes[] = [
                            ...
                            'title' => $row['title'],
                            'namecategories' => $row['namecategories'],
                ...
                echo json_encode(["error" => "No BMI value provided"]);
            }
            ?>
